...
![Стартовое окно Visual Studio Installer, редакция Community 2026](../../screenshots/build/vs-installer-edition.png)
...
![Вкладка Workloads с отмеченной «Desktop development with C++»](../../screenshots/build/vs-workload-cpp.png)
...
![Вкладка Individual components с отмеченным «C++ MFC for latest build tools»](../../screenshots/build/vs-component-mfc.png)
...
> (правка **Ф4‑1**, см. файл `06-build-fieldview.md`). Никаких действий по установке
